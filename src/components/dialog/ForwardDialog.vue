    ...
    <el-dialog
      ...
      <div class="dialog-body" style="background-color: transparent">
        ...
        <template v-if="isSingleChoiceQuestion">
          ...
          <div class="rows">
            <el-checkbox v-model="optionForward"
                         style="margin-right: 0"
                         @change="forward(2)">{{forwardTypes[2]}}</el-checkbox>
            <div v-if="optionForward" style="margin-top: 1rem">
              <table class="forward-table" cellpadding="0" cellspacing="0">
                ...
                <tr v-for="(item, index) of question.answer">
                  ...
                  <td><div>
                    <el-select v-model="optionForwardAction[index].forward"
                               style="width: 100%;">
                      ...
                      <!--<el-option value="-1" label="直接提交为无效答卷"></el-option>-->
        ...
        <div class="rows no-condition-forward">
          <el-checkbox v-model="noConditionForward"
                       style="margin-right: 0"
                       @change="forward(1)">{{forwardTypes[1]}}</el-checkbox>
          <span v-if="noConditionForward">，填写此题后跳转到
            <el-select v-model="forwardAction" style="width: 400px">
              <el-option value="" label="请选择跳转到的题目"></el-option>
              <el-option value="1" label="跳到问卷末尾结束作答"></el-option>
              <el-option v-for="fq of forwardQuestions"
                         :key="fq.sequence"
      ...
      methods: {
        ...
        forward: function(type){
          switch (type) {
            case 1:
              // 无条件跳题
              this.optionForward = false;

              break;
            case 2:
              // 按选项跳题
              this.noConditionForward = false;
              this.optionForwardAction = JSON.parse(JSON.stringify(this.question.answer));
          ...
          if(!!!this.optionForward && !!!this.noConditionForward){
            this.forwardType = 0;
          }
        ...
        cleanForwards: function(){
          ...
          this.forwardType = 0;
          this.noConditionForward = false; // 无条件跳转
          this.optionForward = false; // 按选项跳题
        ...
        closeForwardDialog: function(){
          ...
          console.info('this.forwardType:', this.forwardType);

          this.$set(this.question, 'forwardType', this.forwardType);
          ...
          switch (this.forwardType) {
            ...
            case 1:
              // 无条件跳转
              this.$set(this.question, 'forward', this.forwardAction);
              break;
            case 2:
              // 按选项跳转
              this.$set(this.question, 'answer', this.optionForwardAction);
              break;
          }
